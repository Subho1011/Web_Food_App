...
const Header = (props) => {
  ...
  // Here we are importing the statereducers and dispatch function which we had declared in CartProvider
    ...
    <div className="nav-bar">
      ...
      <Link to="/cart">
        <button className="cart">
          ...
          <span className="cart-value">{cartState.cart.length}</span>
